...
const SignUpPage = () => {
  ...
  return (
    ...
    >
        <div className='p-8'>
            <h2 className='text-2xl sm:text-3xl md:text-4xl font-bold text-center bg-gradient-to-r from-cyan-400 to-sky-600 text-transparent bg-clip-text mb-5'>
				Create Account
			</h2>
            <form 
            ...
            >
                ...
                <motion.button
                    className='mt-5 w-full py-2 px-4 bg-gradient-to-r from-blue-500 to-cyan-600 text-white 
